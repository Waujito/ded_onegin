...
LIBSRC := src/onegin_strs_ptrs.cpp src/onegin_singlebuf.cpp src/onegin_rectangle.cpp src/argparse.cpp src/comparator.cpp src/pvector.cpp src/sort.cpp src/gdb_assertions.cpp
...
CPPSRC := src/onegin.cpp
CPPOBJ := $(CPPSRC:%.cpp=$(BUILD_DIR)/%.o)
APP := $(BUILD_DIR)/onegin
